...
RoninLoadouts["Rifleman"]["Throwable"] = {"M67 Grenade Belt", "M24 Potato Masher Belt", "Molotov Cocktail Belt"};
...
RoninLoadouts["CQB"]["Throwable"] = {"Molotov Cocktail Belt", "Scrambler Belt"};
...
RoninLoadouts["Grenadier"]["Throwable"] = {"M67 Grenade", "M24 Potato Masher Belt"};
...
RoninLoadouts["Sniper"]["Throwable"] = {"Empty Bottle Belt", "Stone Bag"};
...
RoninLoadouts["Engineer"]["Throwable"] = {"Remote Explosive", "Remote Explosive", "Scrambler Belt"};
